...
Usage: Place the FPS named "filtered_transcript_all.table" in the same directory as ORF_all.sh, and run the following command in the Linux terminal: "bash ORF_all.sh". The final output file is OSPS named "filtered_ORF_signal.table" and FPS  named "Search_file.table"  in the OUT folder.
